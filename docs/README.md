...
| [roadmap.md](roadmap.md) | Public roadmap themes from user feedback: engine expansion, drawing polish, attachments, export, Apple integrations, compatibility, and technical investigations. |
