  ...
  private var aboutPage: some View {
    ...
    return VStack(alignment: .leading, spacing: 16) {
      ...
      VStack(spacing: 8) {
        ...
        // When a scheduled check has an update waiting, the row flips to the accent signal and the
        // button becomes the install path (it opens Sparkle's update flow in focus).
        HStack(spacing: 12) {
          VStack(alignment: .leading, spacing: 4) {
